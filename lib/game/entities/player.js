...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/player.png', 16, 16 ),
            ...
            update : function() {
                let accel = this.standing ? this.accelGround : this.accelAir;
    ...
    EntityDeathExplosion = ig.Entity.extend({
        ...
        init : function( x , y , settings ) {
            ...
            for(let i = 0; i < this.particles; i++)
                ig.game.spawnEntity(EntityDeathExplosionParticle, x, y, {colorOffset : settings.colorOffset ?
    ...
    EntityDeathExplosionParticle = ig.Entity.extend({
        ...
        init : function( x, y, settings ) {
            this.parent( x, y, settings );
            let frameID = Math.round(Math.random() * this.totalColors ) + (this.colorOffset * (this.totalColors+1));
    ...
    EntityGrenadeParticle = ig.Entity.extend({
        ...
        init : function( x, y, settings ) {
            ...
            this.idleTimer = new ig.Timer();
            let frameID = Math.round(Math.random() * 7);
            this.addAnim( 'idle', 0.2, [frameID]);
        },
        update : function() {
            if( this.idleTimer.delta() > this.lifetime ) {
